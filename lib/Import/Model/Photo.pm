...
__PACKAGE__->meta->setup(
    ...
    columns => [
        ...
        filename           => { type => 'varchar', length => 64, not_null => 1, remarks => 'Имя файла с оригинальной фотографией' },
        thumbnail_filename => { type => 'varchar', length => 96, not_null => 1, remarks => 'Имя файла с миниатюрой' },
